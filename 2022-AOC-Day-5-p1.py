...
for i in range(len(moves)):
    ...
    for ii in range(moveAmount):
        wsValue = subStacksFinal[moveStart][-1]
        wsValueStart = subStacksFinal[moveStart][0:-1]
        wsValueEnd = subStacksFinal[moveEnd].append(wsValue)
        subStacksFinal[moveStart] = wsValueStart
        print("i: {} / ii: {}: \nwsValue: {} \nwsValueStart: {} \nwsValueEnd: {} \n".format(i, ii, wsValue, wsValueStart, wsValueEnd)) ## TEST REMOVE
...
### PAUSED SECTION FOR CODE MAINTENANCE ABOVE
